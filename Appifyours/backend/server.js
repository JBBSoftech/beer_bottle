...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/beer_bottle_app', {
...
app.listen(PORT, () => {
  console.log(`Beer bottle Backend Server running on port ${PORT}`);
});
